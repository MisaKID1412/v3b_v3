...
def main() -> None:
    ...
    for report_path in args.reports:
        ...
        if report.get("method") not in {
            "matseg_region_material_identity_threshold_v1",
            "matseg_region_material_identity_relative_structural_v2",
            "matseg_rectified_contact_material_identity_v1",
        }:
        ...
        receipt_faces.append(
            {
                ...
                "identity_rule": report.get(
                    "identity_resolution",
                    {"legacy_similarity_threshold": report.get("similarity_threshold")},
                ),
                "changes": changes,
            }
        )
